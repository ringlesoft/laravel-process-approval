                                    ...
                                    <div>
                                        @if($currentApproval->approval_action === \RingleSoft\LaravelProcessApproval\Enums\ApprovalActionEnum::APPROVED->value)
                                            ...
                                            <div
                                                ...
                                                @if($signature = $currentApproval->getSignature())
                                                    <img src="{{$signature}}" class="img-fluid" style="max-height: 50px;" alt="Signature">
                                                @else
                                                    <div style="width: 40px; height: 40px;"
                                                        ...
                                                        <i class="icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12,2C6.486,2,2,6.486,2,12s4.486,10,10,10s10-4.486,10-10S17.514,2,12,2z M12,20c-4.411,0-8-3.589-8-8s3.589-8,8-8 s8,3.589,8,8S16.411,20,12,20z" fill="#FFFFFF"></path><path d="M9.999 13.587L7.7 11.292 6.288 12.708 10.001 16.413 16.707 9.707 15.293 8.293z" fill="#FFFFFF"></path></svg>
                                                        </i>
                                                    </div>
                                                @endif
                                            </div>
                                        @else
                                            <div style="width: 40px; height: 40px;"
                                                ...
                                                <i class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none" opacity=".87"></path><path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.59-13L12 10.59 8.41 7 7 8.41 10.59 12 7 15.59 8.41 17 12 13.41 15.59 17 17 15.59 13.41 12 17 8.41z" fill="#FFFFFF"></path></svg>
                                                </i>
                                            </div>
                                        @endif
                                    </div>
                    ...
                    <div class="row align-content-between align-items-md-center">
                        ...
                        <div class="col-12 col-md-5">
                            <div class="w-100 d-flex justify-content-end gap-2 align-items-md-center">
                                @if($model->isRejected())
                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalDiscard">
                                        Discard
                                    </button>
                                @else
